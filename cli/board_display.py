...
def display_board_fancy(board, last_move=None, captured_pieces=None, use_unicode=True, use_colors=True):
    """
...
if __name__ == "__main__":
    ...
    print(display_board_fancy(board))
    ...
    print(display_board_fancy(board, last_move=last, captured_pieces=captured))
